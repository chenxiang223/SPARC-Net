...
try:
    from .heads import BaselineCosineHead, ClassificationHead, MainAnchoredReliablePrototypeCorrectionHead
...
class SPARCNet(nn.Module):
    ...
    def __init__(
        ...
        if num_classes is None:
            ...
            self.classifier = MainAnchoredReliablePrototypeCorrectionHead(
                adapter_channels,
                num_classes,
                embed_dim=head_embed_dim,
                contrast_dim=head_contrast_dim,
