...
class DecoupledTrainerConfig:
    ...
    calibration: Optional[PostHocCalibrationConfig] = None
...
class DecoupledLongTailTrainer:
    """
    ...
    def __init__(
        ...
        *,
        ...
        config: Optional[DecoupledTrainerConfig] = None,
        ...
        self.logit_calibrator: Optional[PostHocLogitCalibrator] = None
    ...
    def _fit_posthoc_calibration(self, train_loader, *, val_loader=None, balanced_train_loader=None):
        ...
        calibrator = PostHocLogitCalibrator(
